...
func (tc *TokenCreate) SetID(s schema.ID) *TokenCreate {
	tc.mutation.SetID(s)
	return tc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (tc *TokenCreate) SetNillableID(s *schema.ID) *TokenCreate {
	if s != nil {
		tc.SetID(*s)
	}
	return tc
...
func (tc *TokenCreate) SetAccountID(id schema.ID) *TokenCreate {
