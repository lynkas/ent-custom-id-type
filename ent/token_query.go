...
func (tq *TokenQuery) FirstID(ctx context.Context) (id schema.ID, err error) {
	var ids []schema.ID
...
func (tq *TokenQuery) FirstIDX(ctx context.Context) schema.ID {
...
func (tq *TokenQuery) OnlyID(ctx context.Context) (id schema.ID, err error) {
	var ids []schema.ID
...
func (tq *TokenQuery) OnlyIDX(ctx context.Context) schema.ID {
...
func (tq *TokenQuery) IDs(ctx context.Context) ([]schema.ID, error) {
	var ids []schema.ID
...
func (tq *TokenQuery) IDsX(ctx context.Context) []schema.ID {
	ids, err := tq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (tq *TokenQuery) sqlAll(ctx context.Context) ([]*Token, error) {
	...
	if query := tq.withAccount; query != nil {
		...
		nodeids := make(map[schema.ID][]*Token)
		for i := range nodes {
