...
func (au *AccountUpdate) AddTokenIDs(ids ...schema.ID) *AccountUpdate {
...
func (au *AccountUpdate) RemoveTokenIDs(ids ...schema.ID) *AccountUpdate {
...
// AddTokenIDs adds the "token" edge to the Token entity by IDs.
func (auo *AccountUpdateOne) AddTokenIDs(ids ...schema.ID) *AccountUpdateOne {
...
// RemoveTokenIDs removes the "token" edge to Token entities by IDs.
func (auo *AccountUpdateOne) RemoveTokenIDs(ids ...schema.ID) *AccountUpdateOne {
