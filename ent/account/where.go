...
func ID(id schema.ID) predicate.Account {
...
func IDEQ(id schema.ID) predicate.Account {
	return predicate.Account(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldID), id))
	})
}
...
func IDNEQ(id schema.ID) predicate.Account {
	return predicate.Account(func(s *sql.Selector) {
...
func IDIn(ids ...schema.ID) predicate.Account {
	return predicate.Account(func(s *sql.Selector) {
...
func IDNotIn(ids ...schema.ID) predicate.Account {
	return predicate.Account(func(s *sql.Selector) {
		// if not arguments were provided, append the FALSE constants,
		// since we can't apply "IN ()". This will make this predicate falsy.
		if len(ids) == 0 {
...
func IDGT(id schema.ID) predicate.Account {
	return predicate.Account(func(s *sql.Selector) {
...
func IDGTE(id schema.ID) predicate.Account {
	return predicate.Account(func(s *sql.Selector) {
...
func IDLT(id schema.ID) predicate.Account {
	return predicate.Account(func(s *sql.Selector) {
...
func IDLTE(id schema.ID) predicate.Account {
	return predicate.Account(func(s *sql.Selector) {
