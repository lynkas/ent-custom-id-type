...
func (aq *AccountQuery) FirstID(ctx context.Context) (id schema.ID, err error) {
	var ids []schema.ID
...
func (aq *AccountQuery) FirstIDX(ctx context.Context) schema.ID {
...
func (aq *AccountQuery) OnlyID(ctx context.Context) (id schema.ID, err error) {
	var ids []schema.ID
...
func (aq *AccountQuery) OnlyIDX(ctx context.Context) schema.ID {
...
func (aq *AccountQuery) IDs(ctx context.Context) ([]schema.ID, error) {
	var ids []schema.ID
...
func (aq *AccountQuery) IDsX(ctx context.Context) []schema.ID {
	ids, err := aq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (aq *AccountQuery) sqlAll(ctx context.Context) ([]*Account, error) {
	...
	if query := aq.withToken; query != nil {
		...
		nodeids := make(map[schema.ID]*Account)
		for i := range nodes {
